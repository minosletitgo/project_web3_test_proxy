...
describe(" ", function () {  
  ...
  before(async function () {
    ...
    //proxyAsLogic = UUPSU_MyContract_V1.attach(proxyAddress);
    // 这里不使用abi，直接生成逻辑合约实例
    proxyAsLogic = await ethers.getContractAt("UUPSU_MyContract_V1", proxyAddress);
...
/*
  npx hardhat test test/test.UUPSU_MyContract_V1.js --network localHardhat
  npx hardhat test test/test.UUPSU_MyContract_V1.js --network sepolia
*/